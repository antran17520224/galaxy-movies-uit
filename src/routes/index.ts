...
const HomePage = React.lazy(() => import('../modules/HomePage/components/HomePageContainer'));
const DetailsPage = React.lazy(() => import('../modules/Details/components/DetailsPageContainer'));
const TicketingPage = React.lazy(
	() => import('../modules/Ticketing/components/TicketingPageContainer')
);
const ResultPage = React.lazy(() => import('../modules/ResultPage/components/ResultPageContainer'));
