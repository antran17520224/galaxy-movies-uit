...
export const DialogConfirm: React.FC<IProps> = props => {
    ...
    const onAcceptCreate = () => {
        ...
        props.actions.userRegister(dataToRegister);
    };
        ...
        >
            ...
            <DialogContent>
                <DialogContentText id="alert-dialog-description">
                    Vui lòng xác nhận <strong>{dataToRegister.email}</strong> là
                    email của bạn. Chúng tôi sẽ đoạn gửi mã xác nhận đến địa chỉ
                    email này
                </DialogContentText>
            </DialogContent>
            <DialogActions>
